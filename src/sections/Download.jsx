        ...
        <div className="container">
          <div className="flex items-center">
            <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
              <div className="mb-10">
                <img src="/Xora/images/xora.svg" width={160} height={55} alt="" />
              </div>
              <p className="body-1 mb-10 max-w-md">
                Try it now for free on iOS, Android, PC, Web - whatever your
                flavour, we have got you covered
              </p>
            ...
            <div className="mb-10 max-md:hidden">
              <div className="download_preview-before download_preview-after rounded-40 relative w-[995px] border-2 border-s5 p-6">
                <div className="relative rounded-3xl bg-s1 px-6 pb-6 pt-14">
                  ...
                  <img src="/Xora/images/screen.jpg" width={855} height={655} className="rounded-xl" alt="" />
                </div>
              </div>
            </div>
          </div>
