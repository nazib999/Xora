    ...
    <section>
      <Element name="features">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:before-none max-md:rounded-none max-md:gap-3">
