        ...
        <Element name="pricing">
          <div className='container'>
            <div className='max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28'>
                ...
                <div className='relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s1/50 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]'>
                ...
                <img src="/Xora/images/bg-outlines.svg" width={960} height={380} alt="outline" className='relative z-2'/>
                <img src="/Xora/images/bg-outlines-fill.png" width={960} height={380} alt="outline" className='absolute inset-0 opacity-5 mix-blend-soft-light'/>
                </div>
            </div>
                  ...
                  {plan.title}
                    ...
                    <div className='relative z-2 flex items-center justify-center'>
                      <div className={clsx('h-num flex items-center', index === 1? 'text-p3':"text-p4")}>
                        $ <CountUp start={plan.priceMonthly} end={!monthly ? plan.priceMonthly:plan.priceYearly} duration={.4} useEasing={false} preserveValue/>
                      </div>
                      ...
                      <ul className='mx-auto space-y-4 xl:px-7'>
                        {plan.features.map((feature)=>(
                          <li key={feature} className='relative flex items-center gap-5'>
                            <img src="/Xora/images/check.png" alt="check" className='size-10 object-contain'/>
